  ...
  return (
    <div class="hero">
      ...
      <h2 className="heroslogan">
        The Tools You Need <br></br>To Plan Your Next Date
      </h2>
      <div className="content-block">
        ...
        <div className="paragraph2">
          ...
          <p className="para2">
            Leave your worries behind. <br></br> Stay cool and calm. <br></br>{" "}
            Winglet is here.{" "}
          </p>
        </div>
        <br></br>
        <div className="paragraph3">
          ...
          <p className="para3">
            New relationships, new beginnings! <br></br> We’ll help you find
            your way.{" "}
          </p>
        </div>
        <br></br>
        <div className="paragraph4">
          ...
          <p className="para4">
            Spend the majority of your time talking <br></br>about each other
            and not where you should eat.{" "}
          </p>
        </div>
        <br></br>
        <div className="paragraph5">
          ...
          <p className="para5">
            Live outside your cell phone. <br></br>Find adventures and create
            memories.{" "}
          </p>
        </div>
        <br></br>
        <div className="paragraph6">
          ...
          <p className="para6">
            Set the mood right. <br></br> Listen to what you both love.
          </p>
        </div>
      </div>
    </div>
